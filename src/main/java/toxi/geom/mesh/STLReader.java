...
public class STLReader {
    ...
    public Mesh3D loadBinary(InputStream stream, String meshName, int bufSize,
        ...
        try {
            ...
            Logger.getLogger(STLReader.class.getName()).log(Level.SEVERE, null, e);
        }
        return mesh;
    }
    ...
    public Mesh3D loadBinary(String fileName, int bufSize,
        ...
        try {
            ...
            Logger.getLogger(STLReader.class.getName()).log(Level.SEVERE, null, ex);
        }
