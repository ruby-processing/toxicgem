...
class GrayScottToneMap < Processing::App 
  ...
  def setup 
      ...
      grad = Simulation::ColorGradient.new
      # NamedColors are preset colors, but any TColor can be added
      # see javadocs for list of names:
      # http://toxiclibs.org/docs/colorutils/toxi/color/NamedColor::html
      # NB: use '::' in place of '.' here for these java constants
      grad.add_color_at(0, Simulation::NamedColor::BLACK)
      grad.add_color_at(128, Simulation::NamedColor::RED)
      grad.add_color_at(192, Simulation::NamedColor::YELLOW)
      grad.add_color_at(255, Simulation::NamedColor::WHITE)
      ...
      @tone_map = Simulation::ToneMap.new 0, 0.33, grad
  end
...
GrayScottToneMap.new(title: 'Gray Scott Tone Map')
